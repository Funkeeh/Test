...
public class GameStatus2 : MonoBehaviour 
{
	...
	public GameObject neuroSettings;
	...
	{
		//NEUROSTIMSETTINGS  ---------------------------------------------------------------//
		if (neuroSettings.activeSelf == true) 
		{
			currentGame.text = "Mode:";
			gameLevel.text 	= "-";
			gameRound.text 	= "-";
			gameTime.text 	= "-";
			gameScore.text 	= "-";
			gameStatus.text = "Neurostimulator Settings";
		...
		//NO GAME --------------------------------------------------------------------//
		if ( locTraining.activeSelf == false && neuroSettings.activeSelf == false && bendingGame.activeSelf == false 
			&& freqTraining.activeSelf == false && locationGame.activeSelf == false && frequencyGame.activeSelf == false ) 
		{
			currentGame.text = "No Game:";
			gameLevel.text 	= "-";
			gameRound.text 	= "-";
			gameTime.text 	= "-";
			gameScore.text 	= "-";
